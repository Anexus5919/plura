...
export default function Home() {
  return (
      <>
          <section className="w-full pt-36 relative flex items-center flex-col min-h-screen">
          ...
          <section className='flex justify-center flex-col gap-4 md:mt-20 mt-[-60px]'>
            ...
            <p className='text-muted-foreground text-center'>
              Our straigthforward pricing plans are tailored to meet your needs. If {" you're"} not <br /> ready to commit you can get started for free.
            </p>
